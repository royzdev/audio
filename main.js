...
function random_bg_color() {
  ...
  let white = Math.floor(Math.random() * 256) + 64;
  let aqua = Math.floor(Math.random() * 256) + 64;
  let lime = Math.floor(Math.random() * 256) + 64;

  // Construct a color withe the given values
  let bgColor = "rgb(" + white + "," + aqua + "," + lime + ")";
